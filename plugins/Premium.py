...
async def plan(client, message):
    ...
    await message.reply_photo(photo="https://telegra.ph/file/390ced869eff511df4860.jpg", caption=script.PREMIUM_TEXT.format(message.from_user.mention), reply_markup=InlineKeyboardMarkup(btn))
