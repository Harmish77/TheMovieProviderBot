...
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://telegra.ph/file/720af1f9be43ea91b178e.jpg'))
CODE = (environ.get('CODE', 'https://telegra.ph/file/0d3cefb97a13fee34f330.jpg'))
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001644247336').split()] #Channel id for auto indexing ( make sure bot is admin )
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '').split()]
auth_channel = environ.get('AUTH_CHANNEL', '-1001644247336') #Channel / Group Id for force sub ( make sure bot is admin )
...
HOWTOVERIFY = environ.get('HOWTOVERIFY', url='https://t.me/main_movie_hub/47') # How to open tutorial link for verification
...
MSG_ALRT = environ.get('MSG_ALRT', 'ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : HK')
...
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1001684863448'))
